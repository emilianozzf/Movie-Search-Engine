...
- Did you collaborate with any other students/TAs/Professors? Yes, with my partener. 
...
- (Optional) What was your favorite part of the assignment? Figuring out a non-trivial command.
- (Optional) How would you improve the assignment? Adding more features about directories.
...
- Check on Canvas for the Bash tutorial slide deck. 
