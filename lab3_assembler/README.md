...
- Main function calls swap function by passing two addresses of intergers.
- tmp variable stores the value at the address a.
- The value at the address a is replaced by the value at the address b.
- The value at the address b is replaced by the value of tmp variable.
...
### Response/Observations
- We have to deallocate the allocated memory manually when manipulating with dynamic array.
- While static array could be automatically deallocated by garbage management.
